...
export default function CadastroDocente() {
    ...
    return (
         <main>
            <LoginHeader/>
            <div className="relative mx-auto top-20 w-132 h-230 bg-unblightblue border-2 border-unbblue rounded-4xl">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <FormBox name="data contratacao" placeholder="Data de Ingresso" />
            ...
            <div className="absolute top-300 w-screen h-24 bg-unbblue"></div>
        </main>
    )
}