...
export default function CadastroDocente() {
    ...
    return (
         <main>
            <LoginHeader/>
            <div className="relative mx-auto top-20 w-132 h-330 bg-unblightblue border-2 border-unbblue rounded-4xl">
            ...
            <div className="absolute top-390 w-screen h-24 bg-unbblue"></div>
        </main>
    )
}